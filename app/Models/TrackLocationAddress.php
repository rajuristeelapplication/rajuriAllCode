...
class TrackLocationAddress extends CustomModel
{
    use HasFactory;

    protected $table = 'trackLocation_address';
     ...
     */
    protected $fillable = [
        'event','userId','latitude','longitude','title','address','startDateTime','endDateTime','distance','distanceKm','diffMinutes'
    ];

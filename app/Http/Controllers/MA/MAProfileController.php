...
class MAProfileController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function updateProfile(Request $request)
    {
        ...
        $admin = User::where('id', Auth::guard('marketingAdmin')->user()->id)->first();
    ...
    {
        return view('ma.change_password');
    }

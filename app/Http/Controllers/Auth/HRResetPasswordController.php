...
class HRResetPasswordController extends ResetPasswordController
{
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function showResetForm(Request $request, $email = null,  $token = null)
    {
        ...
        if(!empty($record)){
            ...
            return view('hr.auth.reset_password')->with([ 'data' => $data , 'alreadySet' => 0]);
        }
        else
        {
            return view('hr.auth.reset_password')->with([ 'data' => [], 'alreadySet' => 1]);
        }
    ...
    public function changeAdminPassword(Request $request)
    {
        ...
        return view('hr.auth.reset_password', ['data' => $data, 'email' => $request->email, 'api' => 0, 'alreadySet' => 1]);
    }
}

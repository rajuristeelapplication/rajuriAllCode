                            ...
                            <table width="540" border="0" cellspacing="0" cellpadding="0" align="center"
                                ...
                                <tr>
                                    <td class="agile-main scale-center-both"
                                        style="font-weight: 400; color: #000; font-size: 15px; text-align:left; height:34px !important;">
                                        <b>Hi This Mail is send by Admin<b>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="w3l-p2 scale-center-both"
                                        style="font-weight: 400; color: #000; font-size: 14px; line-height: 20px; text-align:left;">
                                        Thanks for using {{ config('app.name') }}. Stay tuned !
                                    </td>
                                </tr>

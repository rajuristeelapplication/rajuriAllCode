...
@endsection
@section('title') {{__('labels.ex_reimbursements')}} @endsection
@section('content')
<!-- BEGIN: Content -->
<div class="content">
    <!-- BEGIN: Top Bar -->
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <a href="{{ route('expense-type-reimbursements.index') }}"><span class="breadcrumb--active">{{__('labels.ex_reimbursements')}}</span></a>
    </div>
    @endsection
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">
                        {{__('labels.ex_reimbursements')}}
                    </h2>
                    <!-- BEGIN: Show Modal Toggle -->
                    <a href="{{ route('expense-type-reimbursements.create') }}" class="ms-auto d-flex align-items-center btn btn-primary"
                        id="addForm">
...
<script>
    ...
    $(function() {
        ...
        table = $('#companyProfiles').DataTable({
            ...
            serverSide: true,
            "ajax": {
                "url": '{{ url(route('expense-type-reimbursements.search')) }}',
                "type": "POST",
                "headers": {
        ...
        $("#companyProfiles").on('change', '.btnChangeStatus', function() {
            ...
            $('#statusTitle').text('Do you really want to ' + status + ' this department?');

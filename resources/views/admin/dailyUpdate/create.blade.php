                                ...
                                <form class="createSchedule" name="scheduleForm" id="scheduleForm" method="post"
                                    ...
                                    <div class="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-form">
                                                ...
                                                <select id="{{__('labels.user_id_db')}}"
                                                    ...
                                                    class="form-select form-select w-100 mt-2 mb-2 ">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-form">
                                                <label class="d-flex flex-column flex-sm-row"> {{__('labels.date')}}
                                                    <span class="text-danger">
                                                        *</span> </label>
                                                <input type="text" name="{{__('labels.date_db')}}"
                                                    id="{{__('labels.date_db')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-form">
                                                <label class="d-flex flex-column flex-sm-row ">
                                                    {{__('labels.firm_name')}}
                                                    <span class="text-danger">*</span> </label>
                                                <input type="text" name="{{__('labels.s_firm_name_db')}}"
                                                    id="{{__('labels.s_firm_name_db')}}"
                                                    class="form-control input-valid w-100 mt-2 mb-2"
                                                    value="{{  $scheduleDetail->sFirmName  ?? '' }}" minlength="4"
                                                    maxlength="40" placeholder="Enter {{__('labels.firm_name')}}"
                                                    aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 slocation">
                                            <div class="input-form">
                                                ...
                                                <input type="text" name="{{__('labels.s_location_db')}}"
                                                    ...
                                                    maxlength="40" placeholder="Enter {{__('labels.location')}}"
                                                    aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="latitudeArea">
                                            ...
                                            <input type="text" id="latitude" name="slatitude" class="form-control">
                                        </div>
                                        <div class="form-group" id="longtitudeArea">
                                            <label>Longitude</label>
                                            <input type="text" name="slongitude" id="longitude" class="form-control">
                                        </div>

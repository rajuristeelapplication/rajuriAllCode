...
@section('title') {{ empty($productDetail) ? 'Create' : 'Edit' }} Product Gift @endsection
@section('css')
...
<div class="content">
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <i class="feather-chevron-right" class="breadcrumb__icon"></i>
        <span class="breadcrumb--active">{{ empty($productDetail) ? 'Create' : 'Edit' }} Product Gift</span>
    </div>
    @endsection
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">{{ empty($productDetail) ? 'Create' : 'Edit' }} Product Gift</h4>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="preview">
                            ...
                            <form class="createProduct" name="productForm" id="productForm" method="post"
                                enctype="multipart/form-data" action="{{route('products-gift.store')}}">
                                @else
                                <form class="createProduct" name="productForm" id="productForm" method="post"
                                    enctype="multipart/form-data" action="{{route('products-gift.store')}}">
                                    ...
                                    <div class="row align-items-end">
                                            ...
                                            <input type="hidden" name="pType" value="Gift" />
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="radio" id="radio"
                                                        value="0"   {{ $checked  }}   {{  !empty($productDetail) && ($productDetail->isProductOption == 0)
                                                    ? ' checked' : ''}}>

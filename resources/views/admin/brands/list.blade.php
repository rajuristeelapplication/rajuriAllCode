...
@endsection
@section('title') {{__('labels.brands')}} @endsection
@section('content')
<!-- BEGIN: Content -->
<div class="content">
    <!-- BEGIN: Top Bar -->
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <a href="{{ route('brands.index') }}"><span class="breadcrumb--active">{{__('labels.brands')}}</span></a>
    </div>
    @endsection
        ...
        <div class="col-span-12 grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    ...
                    <a href="{{ route('brands.create') }}" class="ms-auto d-flex align-items-center btn btn-primary"
                        id="addForm">
...
<script>
    ...
    $("#companyProfiles").on('change', '.btnChangeStatus', function() {
        ...
        $('#statusTitle').text('Do you really want to ' + status + ' this brand ?');

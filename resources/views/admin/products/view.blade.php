...
<div class="content">
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <a href="{{ route('products.index') }}"><span class="breadcrumb">{{__('labels.product')}}</span></a>
        <i class="feather-chevron-right" class="breadcrumb__icon"></i>
        ...
        <div class="col-span-12  grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center justify-content-between h-10">
                    ...
                    <div class="d-flex ">
                        <a href="{{ route('products.edit', ['product' => $productInfo->id ]) }}"
                            class="ms-auto d-flex btn btn-success"> {{__('labels.edit_info')}} </a>
                        <a href="{{ route('products.index') }}" class="ms-3 d-flex btn btn-danger">
                                        ...
                                        <div class="intro-y box col-span-12 lg:col-span-12">
                                            <div class="p-5 border-t border-gray-200">
                                                <div
                                                    ...
                                                    @if ($productInfo->isProductOption == 0)
                                                    <div
                                                        class="truncate sm:whitespace-normal d-flex align-items-center mt-3">
                                                        <div class="col-6 mb-1 mt-1 mr-2 ml-1">
                                                            <b>Price :</b>
                                                            <span class=" mr-2 ml-2">&#8377; {{$productAttributeInfo[0]->totalQty ??'-' }}</span>
                                                        </div>
                                                    </div>
                                                    @endif

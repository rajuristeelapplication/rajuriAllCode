...
@section('title') {{__('labels.gift_report_title')}} @endsection
@section('css')
    ...
    @section('navigation')
        <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
            ...
            <a href="{{ route('admin.visitReport') }}">
                <span class="breadcrumb--active"> {{__('labels.gift_report_title')}}</span>
            </a>
        </div>
        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">{{__('labels.gift_report_title')}}</h2>
                </div>
                <br>
                ...
                <div class="container">
                    ...
                    <form class="form" target="_blank" name="reportMerchandiseGift" id="reportMerchandiseGift" method="post"
                        enctype="multipart/form-data" action="{{ route('admin.merchandiseReport') }}">
                        ...
                        <div class="form-group col-md-4 mt-4">
                            <label for="daterange"><span class="fa fa-filter mb-2"></span> Gift Item </label>
                            <select id="giftItem" name="giftItem" class="form-select form-select mt-2 expense_type">
                                <option value="">All Gift Item</option>
...
<script>
    ...
    $("#reportMerchandiseGift").validate({
        rules: {
            daterange: {
                required: true,
            },
...
<script>
    ...
    // var ajaxUrl = '{{ route('admin.merchandiseReport') }}';

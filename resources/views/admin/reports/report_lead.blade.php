...
@section('title') Lead  Report @endsection
@section('css')
    ...
    @section('navigation')
        <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
            ...
            <a href="{{ route('admin.leadReport') }}">
                <span class="breadcrumb--active"> Lead Report</span>
            </a>
        </div>
        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">Lead Report</h2>
                </div>
                <br>
                ...
                <div class="container">
                    ...
                    <form class="form" target="_blank" name="reportKnowledge" id="reportKnowledge" method="post"
                        enctype="multipart/form-data" action="{{ route('admin.leadReport') }}">
                        ...
                        <div class="form-group col-md-4">
                            <label for="daterange"><span class="fa fa-filter mb-2"></span> Lead Type </label>
                            <select id="lType" name="lType" class="form-select form-select mt-2 lType">
                         ...
                         <div class="form-group col-md-4 mt-4">
                            ...
                            <select id="moveStatus" name="moveStatus" class="form-select form-select mt-2 moveStatus">
...
//     var ajaxUrl = '{{ route('admin.leadReport') }}';

...
@section('title') User  Report @endsection
@section('css')
    ...
    @section('navigation')
        <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
            ...
            <a href="{{ route('admin.userReport') }}">
                <span class="breadcrumb--active"> User Report</span>
            </a>
        </div>
        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">User Report</h2>
                </div>
                <br>
                ...
                <div class="container">
                    ...
                    <form class="form" target="_blank" name="reportUser" id="reportUser" method="post"
                        enctype="multipart/form-data" action="{{ route('admin.userReport') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row ">
                                ...
                                <div class="custom-control col-2 custom-radio">
                                    <input type="radio" id="export_type3"  name="export_type" value="Excel"
                                        class="custom-control-input">
                                    <label class="custom-control-label" for="export_type3">Excel</label>
                                </div>


                                <div class="custom-control col-2 custom-radio">
                                    <input type="radio" id="export_type2" checked name="export_type" value="ViewReport"
                                        class="custom-control-input">
                                    <label class="custom-control-label" for="export_type2">View Report</label>
                                </div>

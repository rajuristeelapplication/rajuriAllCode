...
@section('title') Complaint  Report @endsection
@section('css')
    ...
    @section('navigation')
        <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
            ...
            <a href="{{ route('admin.complaintReport') }}">
                <span class="breadcrumb--active"> Complaint Report</span>
            </a>
        </div>
        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">Complaint Report</h2>
                </div>
                <br>
                ...
                <div class="container">
                    ...
                    <form class="form" target="_blank" name="reportComplaint" id="reportComplaint" method="post"
                        enctype="multipart/form-data" action="{{ route('admin.complaintReport') }}">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="complaintType" name="complaintType" class="form-select form-select mt-2 complaintType">
                                <option value="0">{{ __('labels.all_complaint') }}</option>
...
<script>
    ...
    $('#stateId').on('change', function() {
        ...
        //     var ajaxUrl = '{{ route('admin.complaintReport') }}';
        //     $.ajax({
        //         url: ajaxUrl,
        //         type: "GET",
        //         data: {

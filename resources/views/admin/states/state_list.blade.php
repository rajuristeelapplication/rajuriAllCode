...
@endsection
@section('title') {{__('labels.states')}} @endsection
@section('content')
<!-- BEGIN: Content -->
<div class="content">
    <!-- BEGIN: Top Bar -->
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <a href="{{ route('states.index') }}"><span class="breadcrumb--active">{{__('labels.states')}}</span></a>
    </div>
    @endsection
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">
                        {{__('labels.state_list_title')}}
                    </h2>
                    <!-- BEGIN: Show Modal Toggle -->
                    <a href="{{ route('states.create') }}" class="ms-auto d-flex align-items-center btn btn-primary"
                        id="addForm">
...
<script>
    ...
    $("#states").on('change', '.btnChangeStatus', function() {
        ...
        $('#statusTitle').text('Do you really want to ' + status + ' this state?');

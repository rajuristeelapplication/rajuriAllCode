...
@endsection
@section('title') {{__('labels.departments_list_title')}} @endsection
@section('content')
<!-- BEGIN: Content -->
<div class="content">
    <!-- BEGIN: Top Bar -->
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <a href="{{ route('departments.index') }}"><span
                class="breadcrumb--active">{{__('labels.departments')}}</span></a>
    </div>
    @endsection
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">
                        {{__('labels.departments_list_title')}}
                    </h2>
                    <!-- BEGIN: Show Modal Toggle -->
                    <a href="{{ route('departments.create') }}" class="ms-auto d-flex align-items-center btn btn-primary"
...
@include('admin.departments.model')
@endsection
...
<script>
    ...
    $(function() {
        table = $('#departments').DataTable({
            ...
            serverSide: true,
            "ajax": {
                "url": '{{ url(route('departments.search')) }}',
                "type": "POST",
                "headers": {
    ...
    $("#departments").on('change', '.btnChangeStatus', function() {

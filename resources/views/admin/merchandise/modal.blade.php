                ...
                <div id="vertical-form" class="p-5">
                    <div class="preview">
                        ...
                        <select id="requestStatus" name="requestStatus"
                            class="form-select form-select mt-2 requestStatus">
                            ...
                            <option value="{{__('labels.delivered')}}">{{__('labels.delivered')}}</option>
                        </select>
                    </div>

                    {{-- <div class="preview vehicleNumber">
                        <label for="vertical-form-1" class="form-label mt-2">{{__('labels.vehicle_number')}}</label>
                        <input type="text" name="{{__('labels.vehicle_number_db')}}"
                            id="{{__('labels.vehicle_number_db')}}"
                            class="form-control input-valid w-100 mt-2 mb-2 decimal countInput" minlength="4"
                            maxlength="20" placeholder="Please Enter {{__('labels.vehicle_number')}}"
                            aria-required="true">
                    </div> --}}
                </div>
                <!-- END: Modal Body -->

...
<div class="content">
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <a href="{{ route('schedules.index') }}"><span class="breadcrumb--active">{{__('labels.manage_schedules')}}</span></a>
    </div>
    @endsection
                ...
                <div class="popup-inner-top">
                    <div class="popup-inner-top-title">
                        <div class="popup-inner-top-title-left">
                            ...
                            <div class="info">
                                <div class="caption">Pramod Kandelkar</div>
                                <div class="caption2">Punched-in @ 08:47 am</div>
                                <div class="location"><i class="feather-map-pin"></i>Washim @10:38:00</div>
                            </div>
                        </div>
                    </div>
                    <div class="popup-inner-top-title-bottom">
                        <div class="popup-inner-top-title-bottom-main">
                            ...
                            <div class="popup-inner-top-title-bottom-main-right">
                                ...
                                <span>kms</span>
                                <div class="arc_time">1 hr 52 min</div>
                            </div>
                            <div class="popup-inner-top-title-bottom-main-right">
...
<script>
    ...
    var r = [];
        ...
        for (i = 0; i < coordinates.length; i++) {
            ...
            if (i == 0) {
                markerImage = 'http://localhost/rajuri-steel/public/admin-assets/images/logo/marker.png';
...
{{-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWF9wFs2DV5_Ywpme7CSJg4F1wWOg0yK4&callback=initialize&libraries=places&v=weekly" defer></script> --}}
@endsection

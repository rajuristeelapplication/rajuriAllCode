...
@endsection
@section('title') {{__('labels.material_product')}} @endsection
@section('content')
<!-- BEGIN: Content -->
<div class="content">
    <!-- BEGIN: Top Bar -->
    ...
    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex">
        ...
        <a href="{{ route('material-products.index') }}"><span class="breadcrumb--active">{{__('labels.material_product')}}</span></a>
    </div>
    @endsection
            ...
            <div class="col-span-12 mt-4">
                <div class="intro-y d-flex align-items-center h-10">
                    <h2 class="text-lg font-medium truncate me-4 mb-0">
                        {{__('labels.material_product')}}
                    </h2>
                    <!-- BEGIN: Show Modal Toggle -->
                    <a href="{{ route('material-products.create') }}" class="ms-auto d-flex align-items-center btn btn-primary"
                        id="addForm">
...
<script>
    ...
    $(function() {
        table = $('#companyProfiles').DataTable({
            ...
            serverSide: true,
            "ajax": {
                "url": '{{ url(route('material-products.search')) }}',
                "type": "POST",
                "headers": {
    ...
    $("#companyProfiles").on('change', '.btnChangeStatus', function() {
        ...
        $('#statusTitle').text('Do you really want to ' + status + ' this material product?');

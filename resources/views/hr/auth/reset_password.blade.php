                ...
                <div
                    ...
                    @if (!$alreadySet)
                        <form class="form-horizontal form-material" id="Resetform" method="post"
                            action="{{ route('hr.password.reset_process') }}">
                            @csrf
                            ...
                            <div class="intro-x d-flex text-gray-500 text-xs sm:text-sm mt-4">
                                ...
                                <a href="{{ route('hrLogin') }}">{{__('labels.admin_back_to_login')}}</a>
                            </div>
                    ...
                    @else
                        @if (!empty($data))
                            ...
                            <div class="ml-auto m-t-10">
                                <a href="{{ route('hrLogin') }}" class="text-muted"> {{__('labels.back_to_login_text')}} </a>
                            </div>
                        @else
